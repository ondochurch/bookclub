...
// 새 학기 표시용 NEW 배지. 직접 만든 도형이라 외부 라이선스·저작자 표시 의무가 없다.
// (전에 쓰던 The Noun Project 아이콘은 CC BY라 푸터 크레딧이 필요했다.)
//
// 별 모양은 12갈래 로제트를 좌표로 계산해 뽑았고, 글자는 진짜 <text>다 —
// 굵기·크기는 styles.css의 .new-badge text에서 조절한다. 도형에 구워 넣지 말 것.
// svg에 aria-hidden을 두고 이름은 바깥 span의 aria-label이 담당한다(중복 읽기 방지).
const NEW_ICON =
  '<svg viewBox="0 0 100 100" aria-hidden="true">'
  + '<path d="M45.54,4.37Q50.00,0.00 54.46,4.37L56.15,6.03Q60.61,10.40 66.65,8.84L68.96,8.25Q75.00,6.70 76.68,12.71L77.31,15.00Q78.99,21.01 85.00,22.69L87.29,23.32Q93.30,25.00 91.75,31.04L91.16,33.35Q89.60,39.39 93.97,43.85L95.63,45.54Q100.00,50.00 95.63,54.46L93.97,56.15Q89.60,60.61 91.16,66.65L91.75,68.96Q93.30,75.00 87.29,76.68L85.00,77.31Q78.99,78.99 77.31,85.00L76.68,87.29Q75.00,93.30 68.96,91.75L66.65,91.16Q60.61,89.60 56.15,93.97L54.46,95.63Q50.00,100.00 45.54,95.63L43.85,93.97Q39.39,89.60 33.35,91.16L31.04,91.75Q25.00,93.30 23.32,87.29L22.69,85.00Q21.01,78.99 15.00,77.31L12.71,76.68Q6.70,75.00 8.25,68.96L8.84,66.65Q10.40,60.61 6.03,56.15L4.37,54.46Q0.00,50.00 4.37,45.54L6.03,43.85Q10.40,39.39 8.84,33.35L8.25,31.04Q6.70,25.00 12.71,23.32L15.00,22.69Q21.01,21.01 22.69,15.00L23.32,12.71Q25.00,6.70 31.04,8.25L33.35,8.84Q39.39,10.40 43.85,6.03Z" fill="currentColor"/>'
  + '<text x="50" y="50" text-anchor="middle" dominant-baseline="central">NEW</text>'
  + '</svg>';
